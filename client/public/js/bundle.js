...
var _loginForm = __webpack_require__(4);
...
var loginForm = exports.loginForm = _vue2.default.component('login-form', {
    template: '\
...
\
    ...
    computed: {
        loggedIn: function loggedIn() {
            return _store.store.state.loggedIn;
        },
        loginUrl: function loginUrl() {
            return _store.store.state.API + "sessions/login";
        }
    },
    methods: {
        login: function login() {
            ...
            this.$http.post(loginUrl, {
                ...
                _store.store.commit('logIn', user);
            }, function (error) {
                console.log(error);
            });
        }
...
var profile = exports.profile = _vue2.default.component('profile', {
    template: '\
    ...
    computed: {
        currentUser: function currentUser() {
            return _store.store.state.currentUser;
        },
        loggedIn: function loggedIn() {
            return _store.store.state.loggedIn;
        }
